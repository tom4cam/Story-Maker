// Bob's Big Butter Adventure — 20 rhyming stanzas extracted from the
// original single-page HTML (default-story.html). Used by the seed script
// to populate the English default story.
